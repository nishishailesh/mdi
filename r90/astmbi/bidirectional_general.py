    ...
    while True:      
      ...
      if(self.conn[0] in self.readable):
        ...
        try:
          ...
          print_to_log('(bidirectional_general.py, astmg_loop())Following is received:',data)
          #print([i for i in x])
          print_to_log('(bidirectional_general.py, astmg_loop())Following is received(int data):',[i for i in data])
