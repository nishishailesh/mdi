	#!/usr/bin/python3
lis3_log_filename='/var/log/rp500K_read.log'
lis3_file2mysql_log_filename='/var/log/rp500K_write.log'
...
inbox_data='/root/rp500K.inbox.data/'
inbox_arch='/root/rp500K.inbox.arch/'
outbox_data='/root/rp500K.outbox.data/'
outbox_arch='/root/rp500K.outbox.arch/'
equipment='RP500'
model_string=b'0500'
